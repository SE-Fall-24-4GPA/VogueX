...
def test_model_is_densenet():
    ...
    assert isinstance(model.layers[0], DenseNet121), "The base model is not DenseNet121."
...
def test_embedding_shape():
    ...
    assert sample_embedding.shape[0] > 0, "Embedding array is empty or incorrectly formatted."
